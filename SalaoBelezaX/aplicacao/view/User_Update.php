	...
	<body>
		...
		<form action="" method="post" id='form'>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="nome" name="nome_user" value="<?=$user->getNomeUser()?>" placeholder="Lucas João Silva">
			</div>

			<div class="form-group">
				<label for="email">E-mail:</label>
				<input type="email" class="form-control" id="email" name="email_user" value="<?=$user->getEmailUser()?>" placeholder="exemplo@exemplo.com">
			</div>
			...
			<input type='button' onclick='Validar()' value='Salvar' class='btn btn-success' class='form-group'>
